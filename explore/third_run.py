...
# Padding the centroid histories to have the same length
...
ani_multiple = animation.FuncAnimation(fig, animate_multiple_centroids, frames=max_iterations, repeat=True)
plt.close(fig)
ani_multiple.save("../data/centroids_animation.mp4", writer='ffmpeg', fps=10)
